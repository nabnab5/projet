...
const Graphs1 = ({navigation}) =>{
      ...
      const  getGraph = async() => {
        useFocusEffect(
        await firebase.firestore().collection('temperature')
  ...
  return(
        ...
        <ScrollView horizontal={true}  >
                   ...
                   <View style={{
                       ...
                       />
                       <Button  color='#568778' fontWeight='bold' title="temperature" onPress={() => navigation.navigate('Graphs1')}/>
                   </View>
                   ...
                   <View style={{
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  color='#9CCBBD' fontWeight='bold' title="         Sleep         " onPress={() => navigation.replace('Graphs4')}/>
                   </View>
                   </ScrollView>
