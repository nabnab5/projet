...
import firebase from '../firebase/fire';
    ...
    const Graphs3 = ({navigation}) =>{
      ...
      <ImageBackground source={require('../assets/background/3.png')} style={styles.Backgroundcontainer}>
        <View style={{alignItems: 'center',marginBottom: 70}}>
          ...
          <Text style={{color:'#568778',fontSize: 25,fontWeight: 'bold',marginTop: 10,opacity: 0.8}} >weight</Text>
        </View>
        <ScrollView horizontal={true}  >
                   ...
                   <View style={{
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  color='#568778' fontWeight='bold' title="     weight   " onPress={() => navigation.navigate('Graphs3')}/>
                   </View>
                   <View style={{
                       alignItems:"center",
                       backgroundColor:"#9CCBBD",
  ...
  data={{
    ...
    datasets:[
      {
        data: [userData ? userData.Wone : "0",userData ? userData.Wtwo : "0", userData ? userData.Wthree : "0.1", userData ? userData.Wfour : "0",userData ? userData.Wfive : "0",userData ? userData.Wsix : "0",userData ? userData.Wseven : "0",userData ? userData.Weight : "0"  ],
