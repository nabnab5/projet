...
import firebase from '../firebase/fire';
    ...
    const Graphs5 = ({navigation}) =>{
      ...
      <View style={{alignItems: 'center',marginBottom: 70}}>
          <Image source={require('../assets/background/baby-mobile.png')} style={{width: 70,height: 70,}} />
          <Text style={{color:'#568778',fontSize: 25,fontWeight: 'bold',marginTop: 10,opacity: 0.8}} >Sleep</Text>
        </View>
        <ScrollView horizontal={true}  >
                   ...
                   <View style={{
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  color='#568778' fontWeight='bold' title="         Sleep         " onPress={() => navigation.navigate('Graphs4')}/>
                   </View>
                   </ScrollView>
    ...
    <View style={{flexDirection:'row' ,paddingHorizontal:30,marginTop:40,alignItems:'center',justifyContent:'center'}}>
     ...
     <LineChart
  data={{
    labels: [userData ? userData.Tone : "0",userData ? userData.Ttwo : "0", userData ? userData.Tthree : "0", userData ? userData.Tfour : "0",userData ? userData.Tfive : "0",userData ? userData.Tsix : "0",userData ? userData.Tseven : "0",userData ? userData.Teight : "0/30"],
    datasets:[
      {
        data: [userData ? userData.Sone : "5",userData ? userData.Stwo : "8", userData ? userData.Sthree : "7", userData ? userData.Sfour : "8",userData ? userData.Sfive : "8",userData ? userData.Ssix : "8",userData ? userData.Sseven : "8",userData ? userData.Seight : "8"],
